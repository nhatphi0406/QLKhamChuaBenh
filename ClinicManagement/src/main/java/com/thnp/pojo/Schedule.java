...
@NamedQueries({
    ...
    @NamedQuery(name = "Schedule.findByWorkingDay", query = "SELECT s FROM Schedule s WHERE s.workingDay = :workingDay")})
public class Schedule implements Serializable {
    ...
    public Schedule(Integer id, Date workingDay) {
        this.id = id;
    ...
    public String toString() {
        return "com.thnp.pojo.Schedule[ id=" + id + " ]";
    }
